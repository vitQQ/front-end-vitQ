...
export default function Home() {
  ...
  const jumlahKalori = user?.result?.kaloriHarian
    ? user?.result?.kaloriHarian?.toFixed()
    : "Belum di atur";
        ...
        <Container fluid className="px-0">
                  ...
                  <Col className="p-3">
                    <div className="bg-secondary-1 rounded p-3 d-flex justify-content-center flex-column align-items-center">
                      ...
                      <div className="text-center">
                        “Jumlah kalori yang perlu Anda makan mungkin bukan
                        standar 2.000Kkal”
                      </div>
                    </div>
                  </Col>
                      ...
                      >
                        <Row>
                          <Col sm={7} xs={7}>
                            ...
                            <div className="fs-h2 fw-bold mb-2">
                              {emisi} Emisi
                            </div>
                            <div className="fs-caption textInActive mb-3">
                              {emisi < 1
                                ? "Asik, Emisi kamu menunjukkan hal yang sangat baik"
                                : emisi < 1.5
                                ? "Oke, Emisi kamu menunjukan hal yang cukup baik"
                                : emisi < 2.5
                                ? "Yah, Emisi kamu menunjukan hal yang kurang baik"
                                : "Gawat, Emisi kamu menunjukan hal yang tidak baik"}
                            </div>
                          </Col>
          ...
          a 15.9155 15.9155 0 0 1 0 -31.831"
                              ...
                              <div className="fs-subtitle fw-bold text-center text-primary-3">
                                {jumlahKalori !== "Belum di atur" ? (
                                  `${kalori} / ${jumlahKalori} Kkal`
                                ) : (
                                  <Link to="/akunku/editprofil">
                                    Atur Profile Dahulu
                                  </Link>
                                )}
                                {/* {kalori} / {jumlahKalori} Kkal */}
                      ...
                      <div className="rounded p-3 border bg-white pointer">
                        <Row>
                          ...
                          <Col className="m-auto">
                            ...
                            <div className="d-none d-md-block d-lg-block d-xl-block">
                              Istirahat sejenak, pilih makanan yang memiliki
                              gizi seimbang
                            </div>
                          </Col>
                        </Row>
                      ...
                      <div className="rounded p-3 border bg-white pointer">
                        <Row>
                          ...
                          <Col className="m-auto">
                            ...
                            <div className="d-none d-md-block d-lg-block d-xl-block">
                              Waktunya istirahat, cermat dalam memilih makanan
                              agar tetap sehat
                            </div>
                          </Col>
                        </Row>
              ...
              <div className="rounded p-3 border mt-5">
                <Row>
                  <Col xs={12} md={6}>
                    ...
                    <div className="mb-4">
                      Setelah makan kamu meninggalkan emisi karbon, maka dari
                      itu kamu perlu melakukan kegiatan lingkungan
                    </div>
