  ...
  return (
    <div className="container mt-5">
      ...
      <div className="row my-5 mx-1 p-3 border rounded">
        <form onSubmit={handleSubmit(onSubmit)} className="col-lg-7 col-xl-7 col-xxl-7 col-12" noValidate>
          <div className="umurdanJenisKelamin my-5">
            ...
            <div className="row justify-content-start">
              <div className="col-lg-4 col-xxl-4 col-xl-4 col-md-4 col-sm-6 col-6">
                <input type="number" {...register("umur", { required: true })} className={errors?.umur ? "is-invalid form-control" : "form-control"} placeholder="cth. 20" defaultValue={user.length !== 0 ? user.result.umur : null} />
                ...
                <div className="row">
                  <div className="col-lg-6 col-md-6 col-xl-6 col-xxl-6 col-6 col-gender px-auto">
                    <input
                      ...
                      type="radio"
                      className={errors?.jenisKelamin ? "is-invalid form-check-input input-hidden py-2" : "form-control input-hidden py-2"}
                      id="male"
                      value="L"
                      {...(user.length !== 0 ? (user.result.jenisKelamin === "L" ? { checked: true } : null) : null)}
                    />
                    <center>
                      <label htmlFor="male">
                        <img src={male} alt="I'm sad" className="px-lg-3 px-xl-3 px-xxl-3 px-md-3 px-sm-3 px-2 py-1 img-gender" />
                      </label>
                    </center>
                  </div>
                  <div className="col-lg-6 col-md-6 col-xl-6 col-xxl-6 col-6 col-gender py-0">
                    <input
                      {...register("jenisKelamin", { required: true })}
                      type="radio"
                      class={errors?.jenisKelamin ? "is-invalid form-check-input input-hidden py-2" : "form-control input-hidden py-2"}
                      id="female"
                      value="P"
                      {...(user.length !== 0 ? (user.result.jenisKelamin === "P" ? { checked: true } : null) : null)}
                    />
                    <center>
                      <label htmlFor="female">
                        <img src={female} alt="I'm sad" className="px-lg-3 px-xl-3 px-xxl-3 px-md-3 px-sm-3 px-2 py-1 img-gender" />
                      </label>
                    </center>
                  </div>
                </div>
          ...
          <div className="beratdantinggibadan my-5">
            ...
            <div className="row gx-5 d-flex align-items-center">
              <div className="col-lg-3 col-xl-3 col-xxl-3 col-md-3 col-sm-4 col-6 d-flex align-items-center">
                <input type="number" {...register("berat_badan", { required: true })} className={errors?.berat_badan ? "is-invalid form-control" : "form-control"} defaultValue={user.length !== 0 ? user.result.berat_badan : null} />
              ...
              <div className="col-lg-3 col-xl-3 col-xxl-3 col-md-3 col-sm-4 col-6 d-flex align-items-center">
                <input type="number" {...register("tinggi_badan", { required: true })} className={errors?.tinggi_badan ? "is-invalid form-control" : "form-control"} defaultValue={user.length !== 0 ? user.result.tinggi_badan : null} />
                {/* <div className="invalid-feedback">
                  {errors.tinggi_badan &&
              ...
              <div className="col-12 col-xxl-8 col-xl-8 col-lg-8 col-md-8 d-flex align-items-center">
                <div className="select w-100">
                  <select {...register("activity_level", { required: true })} className={errors?.activity_level ? "is-invalid form-select w-100 m-auto m-3 p-2" : "form-select w-100 m-auto m-3 p-2"}>
                    ...
                    <option {...(user.length !== 0 ? (user.result.activity_level === 1 ? { selected: true } : null) : null)} value={parseInt("1")}>
                      sangat sedikit atau tidak sama sekali
                    </option>
                    <option {...(user.length !== 0 ? (user.result.activity_level === 2 ? { selected: true } : null) : null)} value={parseInt("2")}>
                      Sedikit aktif (1-3 hari/minggu)
                    </option>
                    <option {...(user.length !== 0 ? (user.result.activity_level === 3 ? { selected: true } : null) : null)} value={parseInt("3")}>
                      Sedang (3-5 hari/minggu)
                    </option>
                    <option {...(user.length !== 0 ? (user.result.activity_level === 4 ? { selected: true } : null) : null)} value={parseInt("4")}>
                      Sangat aktif (6-7 hari/minggu
                    </option>
                    <option {...(user.length !== 0 ? (user.result.activity_level === 5 ? { selected: true } : null) : null)} value={parseInt("5")}>
