  ...
  return (
    <div className="container mt-5">
      ...
      <div className="row ms-3 my-5">
            ...
            <div className="row justify-content-start">
              <div className="col-lg-4 col-xxl-4 col-xl-4 col-md-4 col-sm-6 col-6">
                <input
                  ...
                  className={
                    errors?.umur ? "is-invalid form-control" : "form-control"
                  }
                  placeholder="cth. 20"
            ...
            <div className="row gx-5 d-flex align-items-center">
              <div className="col-8 d-flex align-items-center">
                <div className="select w-100">
                  ...
                  <button
                    className="w-100 p-2 my-5 btn-primary-3 text-white rounded-3"
                    type="submit"
                  >
                    Selesai
                  </button>
        ...
        <div className="col-5 d-none d-lg-block d-xl-block d-xxl-block rounded-4">
