    ...
    <div className="container px-0 py-3">
      <div className="row my-5 py-5">
        <div className="col-xxl-5 col-xl-5 col-lg-5 col-12 order-12 order-lg-first order-xxl-first order-xl-first order-last my-5">
          {emailExist ? (
            <>
              <p className="alert bg-secondary-1 text-secondary-4" role="alert">
                Email anda telah terdaftar, silahkan melakukan login
              </p>
              <br />
            </>
          ) : (
          ...
          <form
            ...
            className="row g-3 border border-light px-3 py-3"
          >
            <h1 className="fs-display fw-bold text-primary">Daftar</h1>
            <h3 className="fs-h3 text-active mb-5">
              Buat akunmu untuk menelusuri fitur-fitur menarik dari VitQ
            </h3>
            <div className="col-12 mb-3">
              <label
                htmlFor="validationServer01"
                className="form-label fs-h3 text-active fw-semibold"
              >
                Nama
              </label>
              <input
            ...
            <div className="col-12 mb-4">
              ...
              />
              {errors.password && (
                <p className="text-secondary-3 mt-2">
              ...
              <div className="d-flex mt-2 mb-4">
                ...
                />
                <label htmlFor="inlineCheckbox1" className="ms-2">
                  {" "}
                  Tampilkan Password
                </label>
              </div>
              <p className="my-2 text-disable fs-subtitle">
                Dengan mendaftar, saya menyetujui{" "}
                <Link to={`/`}>
                  <span className="text-primary-3"> syarat dan ketentuan </span>
                </Link>
                syarat dan{" "}
                <Link to={`/`}>
            ...
            <p className="text-inactive fs-body text-center">
              Sudah punya akun?
